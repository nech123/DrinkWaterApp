...
import Animated, { useAnimatedProps, useSharedValue, interpolate, withTiming, Easing, withRepeat } from 'react-native-reanimated';
...
export function Home() {
  ...
  const buttonProps = useAnimatedProps(()=>{
    return {
      ...
      strokeWidth: interpolate(buttonBorderAnimated.value, [0,  .5, 1], [17, 40, 17]),
